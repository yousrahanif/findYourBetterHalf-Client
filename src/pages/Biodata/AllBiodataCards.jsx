...
{name.toUpperCase()}
  ...
  <div className="mb-2 mt-2.5 flex flex-col items-center "> 
    ...
    <div className="flex items-center"> 
      <p className="mr-2">Career: {occupation} </p>
    </div>
    <div className="flex items-center"> 
      <p className="mr-2">Division: {permanent_division} </p>
    </div>
    </div>
           <div className="flex items-center justify-center">
           <Link to={`/biodata/${_id}`}>
  <button className="rounded-lg bg-red-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800">
    View Profile
  </button>
</Link>
           </div>
